...
object ShowData {
    val episodes: List<ShowEpisode> = listOf(
        ShowEpisode(
            ...
            brand = Brand.RAW,
            weekNumber = 1,
            notes = "WWE Draft Night / Season Opener"
        ),
        ShowEpisode(
            id = 2,
            episodeNumber = 1,
    ...
    val matches: List<Match> = listOf(
        ...
        Match(
            ...
            showType = Show.SHOW,
            slot = CardSlot.MID,
            participants = "Booker T vs Matt Hardy",
            stipulation = "Normal",
            winnerId = 6,
        ...
        Match(
            ...
            showType = Show.SHOW,
            slot = CardSlot.MID,
            participants = "The Dudley Boys vs Los Guerreros",
            stipulation = "Normal",
            winnerId = 8,
            winnerLabel = "The Dudley Boys",
            isTagMatch = true,
            participantIds = listOf(8, 14, 15, 10),
        ...
        Match(
            ...
            showType = Show.SHOW,
            slot = CardSlot.MAIN,
            participants = "Steve Austin vs Shawn Michaels",
            stipulation = "Normal",
            winnerId = 51,
